    ...
    return (
      <div className='max-w-4xl mx-auto px-6 py-12'>
        ...
        <div className='bg-white dark:bg-earth-800 border border-earth-200 dark:border-earth-700 rounded-xl p-8 sm:p-12 text-center'>
          <div className='w-20 h-20 bg-sage-50 dark:bg-sage-900/20 rounded-2xl flex items-center justify-center text-4xl mx-auto mb-6'>
            ☁️
          </div>
    ...
    <div className='max-w-6xl mx-auto px-6 py-12'>
      ...
      <div className='bg-sage-50 dark:bg-sage-900/20 border border-sage-200 dark:border-sage-700 rounded-xl p-6 sm:p-8 mb-8'>
        <div className='flex flex-col sm:flex-row items-center gap-6'>
          <div className='w-16 h-16 bg-sage-600 rounded-xl flex items-center justify-center text-white text-2xl font-bold'>
