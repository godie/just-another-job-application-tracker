...
export const ScanResults: React.FC<ScanResultsProps> = ({
  ...
  return (
    <div className="space-y-6 mt-8 transition-[opacity,transform]">
      {preview.proposedAdditions.length > 0 && (
        <section className="animate-in fade-in slide-in-from-bottom-4 duration-500 transition-[opacity,transform]">
      ...
      {preview.proposedUpdates.length > 0 && (
        <section className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150 transition-[opacity,transform]">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-lg font-semibold text-foreground flex items-center gap-2">
