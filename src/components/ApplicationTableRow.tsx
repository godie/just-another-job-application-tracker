...
/**
 * ApplicationTableRow component for rendering a single row in the job application table.
 * ⚡ Bolt: This component has been optimized by removing expensive DOMPurify calls
 * and dangerouslySetInnerHTML. Data is now sanitized at the storage level, and
 * React's built-in escaping is used for rendering, which is faster and safer.
 * Multiline support for notes is handled via CSS white-space: pre-line.
 */
