  ...
  return (
    <header className="flex items-center justify-between p-4 border-b border-gray-200 bg-white shadow-sm dark:bg-gray-800 dark:border-gray-700 fixed top-0 left-0 right-0 z-50 h-16">
      <div className="flex items-center gap-4">
        ...
        <div className="hidden md:block lg:hidden text-2xl font-extrabold text-indigo-700 dark:text-indigo-400" data-testid="app-title-tablet">
          JAJAT
        </div>
        {/* Title: Full text for desktop (>= 1024px) */}
        <div className="hidden lg:block text-2xl sm:text-3xl font-extrabold text-indigo-700 dark:text-indigo-400" data-testid="app-title">
