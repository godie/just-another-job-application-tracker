...
const ATSSearch: React.FC = () => {
  ...
  return (
    <Card className='overflow-hidden mb-6'>
      <div
        className='px-6 py-4 flex justify-between items-center cursor-pointer hover:bg-earth-50 dark:hover:bg-earth-700 transition-colors'
      ...
      >
        <div className='flex items-center gap-3'>
          <div className='p-2 bg-sage-100 dark:bg-sage-900/30 rounded text-sage-600 dark:text-sage-400'>
        ...
        <Button variant='ghost' size='icon' className='text-earth-400'>
          <svg
      ...
      {isExpanded && (
        <div className='px-6 pb-6 pt-4 border-t border-earth-100 dark:border-earth-700 bg-earth-50/30 dark:bg-earth-800/50'>
          ...
          <div className='mb-2'>
            <label className='block text-xs font-semibold text-earth-500 dark:text-earth-400 uppercase tracking-wider mb-3'>
            ...
            <div className='flex flex-wrap gap-2'>
              {ATS_PLATFORMS.map((platform) => (
                <Button
                  ...
                  className='px-4 py-2 h-auto text-sm font-medium transition-all flex items-center gap-2 group'
                >
                  <span className='text-earth-400 group-hover:text-sage-500 transition-colors'>
          ...
          <div className='flex justify-end mt-6 pt-4 border-t border-earth-100 dark:border-earth-700'>
            <Button
              variant='primary'
              onClick={handleSearchAll}
              className='px-6 py-2.5 active:transform active:scale-95'
            >
