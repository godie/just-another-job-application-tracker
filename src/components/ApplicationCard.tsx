...
/**
 * ApplicationCard component for mobile view.
 * ⚡ Bolt: Optimized by removing DOMPurify and dangerouslySetInnerHTML.
 * React handles escaping, and data is sanitized at the storage level.
 */
